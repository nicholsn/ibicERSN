...
PGM="ibicERSN -- Version 2.2" ;
	...
	echo "12/30/12		  2.3  Added PowerSpectrum plot"
	echo "================================================================="
	echo "Usage: "
...
rm -rf temp*
# 12/28/12 -- improve the non-tissue mask -- end
...
NumSpikes=`octave -q ${DOTMFILELOCAT}/ibicERSNtstv2_3.m | awk '{print $3}'`
...
cp MaxPowerSpectrum.png ${CURRENT}/${STRIPPEDFNAME}_ERSNMaxPowerSpectrum.png
